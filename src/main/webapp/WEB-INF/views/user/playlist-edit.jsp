    ...
    <div class="card-body">
      <form id="editPlaylistForm"
        ...
        <div class="mb-4 p-3 bg-light rounded">
          <h5><i class="bi bi-info-circle me-1"></i>Playlist Information</h5>
          <div class="row text-secondary">
            ...
            <div class="col-sm-4 mb-2">
              ...
              <strong>
                <i class="bi ${playlist.visibility == 'public' ? 'bi-globe2' : 'bi-lock-fill'} me-1"></i>
                ${playlist.visibility}
              </strong>
            </div>
          </div>
        ...
        <div class="d-flex justify-content-between">
          ...
          <div>
            <button type="button"
                    ...
                    onclick="if(confirm('Delete this playlist?')) location.href='${pageContext.request.contextPath}/user/playlist/${playlist.playlistId}/delete';">
